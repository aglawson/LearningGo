...
func (_Token *TokenCaller) BalanceOf(opts *bind.TransactOpts, tokenOwner common.Address) (*types.Transaction, error) {
...
//
// Solidity: function balanceOf(address tokenOwner) returns(uint256 balance)
func (_Token *TokenCallerSession) BalanceOf(tokenOwner common.Address) (*types.Transaction, error) {
	return _Token.Contract.BalanceOf(nil, tokenOwner)
}
